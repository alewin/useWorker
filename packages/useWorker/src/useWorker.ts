...
import { TRANSFERABLE_TYPE, UseWorkerOptions, WorkerController, WORKER_STATUS } from "./lib/types";
 ...
 */
export const useWorker = <T extends (...fnArgs: any[]) => any>(fn: T, options: UseWorkerOptions = DEFAULT_OPTIONS) => {
